...
<html lang="en">
    ...
    <body>
        <form action="ProductServlet" method="post">
            <table>
                <h1>Update Book ID :${requestScope.product.productID}</h1>
               <tr>
                    <td>Product ID:</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="shortDescription" value="${requestScope.product.shortDescription}"></td>
                    <td><font color="red">${requestScope.INVALID.shortDescriptionError}</font></td>
                </tr>
                <tr>
                    <td>Product Description:</td>
                    <td><input type="text" name="productDescription" value="${requestScope.product.productDescription}"></td>
                    <td><font color="red">${requestScope.INVALID.productDescriptionError}</font></td>
                </tr>
                <tr>
                    <td>Image:</td>
                    <td><input type="text" name="txtimage" value="${requestScope.product.imageUrl}"/></td>
                    <td><font color="red">${requestScope.INVALID.imageUrlError}</font></td>
                </tr>
                <tr>
                    <td>Category name:</td>
                    <td>
                ...
                <tr>
                    <td>
                        <input type="submit" name="action" value="Updates"/>
                    </td>
                </tr>
            </td>
            </table>
