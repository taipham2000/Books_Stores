                                ...
                                <div class="woocommerce">
                                    <form action="ProductServlet" method="post">
                                        <select name="userID">
                                            ...
                                            <c:forEach items="${listA}" var="list">
                                                <option value="${list.userID}" selected>${list.username}</option>
                                            </c:forEach>
                                    ...
                                    <table cellspacing="0" class="shop_table cart">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${requestScope.listH}" var="listH">
                                            <tr>

                                                <td><img src="img/${listH.imageUrl}" height="10px"/></td>
                                                <td>${listH.productName}</td>
                                                <td>${listH.price}</td>
                                                <td>${listH.quantity}</td>
                                                <td>${listH.date}</td>
                                            </tr>
